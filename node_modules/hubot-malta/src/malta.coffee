...
#   tebot i have an idea - OK then, out with it... just shout it out
...
module.exports = (robot) ->
  ...
  robot.respond /list me/i, (msg) ->
    ...
    t = t + "Try '#{robot.name} I know COBOL' to tell what language you like to code with" if lang == null
    msg.send t

  robot.respond /I know (.*)/i, (res) ->
    username = res.envelope.user.name
    robot.brain.set "language:#{username}", res.match[1]
    l = robot.brain.get "listed:#{username}"
    t = t + "Thanks.  I'll be sure to mention it."
