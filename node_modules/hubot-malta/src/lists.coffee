...
#
  robot.respond /list users/i, (msg) ->
    ...
    if c > 0
      ...
      msg.send "Nobody is listed as unteamed.  Try '#{robot.name} find me a team' or 'tebot list me'."
  ...
  robot.respond /list ideas/i, (msg) ->
    ...
    if ideas.length > 0
      ...
      t = t + "No ideas so far!\n"
      t = t + "Try 'tebot list me' or 'tebot, I have an idea'\n"
      t = t + "You can also 'tebot list users' to find more people that need a team."
      msg.send t
      return false
    if c > 0
      t = t + "Say '#{robot.name} idea #N' if you want to join a team,\n"
      t = t + "or say '#{robot.name} I have an idea' to list your own idea."
      msg.send t
    else
